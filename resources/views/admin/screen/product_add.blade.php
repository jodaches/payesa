            ...
            <form action="{{ route('admin_product.create') }}" method="post" name="form_name" accept-charset="UTF-8" 
                ...
                <div class="box-body" id="main-add">
                    <div class="fields-group">
                            ...
                            <div class="col-sm-8">
                                <div class="input-group">
                                    ...
                                    <input type="text" id="{{ $code }}__keyword"
                                        ...
                                        class="form-control input-sm {{ $code.'__keyword' }}" placeholder="Para búsquedas" />
                                </div>
                        ...
                        <div
                            class="hide form-group   kind kind0  {{ $errors->has('descriptions.'.$code.'.content') ? ' has-error' : '' }}">
                        ...
                        {{-- alias --}}
                        <div class="hide form-group  kind kind0 kind1 kind2 {{ $errors->has('alias') ? ' has-error' : '' }}">
                    ...
                    <div class="col-sm-8">
                        <div class="input-group">
                            ...
                            <input type="number" style="width: 100px;" id="lower_price" name="lower_price" step="0.01"
                                value="{!! old('lower_price',0) !!}" class="form-control input-sm price"
                                placeholder="" />
                        </div>
